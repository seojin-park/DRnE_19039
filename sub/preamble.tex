...
\title{라즈베리파이를 활용한 자동기상관측장비(AWS)의 제작} % 제목 개행 시 \linebreak 사용. \\나 \newline 은 안됨.
\englishtitle{Production of Automatic Weather Station using Raspberry Pi}% 제목 개행 시 \linebreak 사용. \\나 \newline 은 안됨.

\author[1] {한수민} % 제 1 저자명
\email[1]{(polaris041437@gmail.com)} % 제 1 저자 이메일
\author[2] {박서진} % 제 2 저자명
\email[2]{tallyfieh1247@gmail.com} % 제 2 저자 이메일
\advisor{박기현} % 지도교사명
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\summitdate{2019}{11}{06} % 제출일 (연, 월, 일)
